...
dir1 <- "~/Downloads/quali_emocemp" #Insira o caminho para a pasta com os arquivos
file_v1 <- "EMOCEMP V1 - Oficial_January 18, 2020_07.35.csv" #Insira o nome do arquivo .csv com dados da visita 1
file_v2 <- "EMOCEMP V2 - Oficial_January 21, 2020_13.37.csv" #Insira o nome do arquivo .csv com dados da visita 2
